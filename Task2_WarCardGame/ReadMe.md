...
Examples of the class's functionality can be found in [Demo.cpp]([Demo.cpp](https://github.com/DorHarizi/Cpp_Assignments/blob/main/Task2_WarCardGame/Task2_Test/Demo.cpp)
)
.
